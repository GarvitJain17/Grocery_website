...
const Cart = () => {
  ...
  const handlesave= async()=>{
    ...
    const {email}=user; 
    // console.log(email);
    const res = await fetch(`${process.env.REACT_APP_SERVER_DOMIN}saveCart`,{
      method : "POST",
      headers  : {
  ...
  return (
    <>
      ...
      <button className="btn cursor-pointer" onClick={handlesave}>save</button>
      </div>
